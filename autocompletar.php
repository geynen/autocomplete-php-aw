 ...
 * Copyright Geynen. 
 * Fecha: 25-03-2011 Chiclayo - Perú
 * Version: 1.0
  ...
  if(!e) e = window.event; 
    ...
    if(keyc == 38 || keyc == 40 || keyc == 13) {
		...
		if(div=='divregistrosPersona'){
			...
			listadoPersona(div,document.getElementById('txtPersona').value);
		}
...
function mostrarPersona(id,div){
		...
		g_ajaxPagina.setURL("ajaxPersona.php");
		g_ajaxPagina.setRequestMethod("POST");
		g_ajaxPagina.setParameter("action", "mostrarPersona");
